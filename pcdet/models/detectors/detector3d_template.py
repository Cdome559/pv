...
class Detector3DTemplate(nn.Module):
    def __init__(self, model_cfg, num_class, dataset):
        ...
        self.module_topology = [
            'backbone_3d', 'vfe', 'voxelbackbone_3d', 'map_to_bev_module', 'pfe',
    ...
    def build_voxelbackbone_3d(self, model_info_dict):
        if self.model_cfg.get('VOXELBACKBONE_3D', None) is None:
            return None, model_info_dict

        voxelbackbone_3d_module = backbones_3d.__all__[self.model_cfg.VOXELBACKBONE_3D.NAME](
            model_cfg=self.model_cfg.VOXELBACKBONE_3D,
            input_channels=model_info_dict['num_point_features'],
            grid_size=model_info_dict['grid_size'],
            voxel_size=model_info_dict['voxel_size'],
            point_cloud_range=model_info_dict['point_cloud_range']
        )
        model_info_dict['module_list'].append(voxelbackbone_3d_module)
        model_info_dict['num_point_features'] = voxelbackbone_3d_module.num_point_features
        model_info_dict['backbone_channels'] = voxelbackbone_3d_module.backbone_channels \
            if hasattr(voxelbackbone_3d_module, 'backbone_channels') else None
        return voxelbackbone_3d_module, model_info_dict
