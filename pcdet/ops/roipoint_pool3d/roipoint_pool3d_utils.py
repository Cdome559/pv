...
class RoIPointPool3d(nn.Module):
    def __init__(self, num_sampled_points=512, pool_extra_width_factor = 1.2):#pool_extra_width=1.0
        super().__init__()
        self.num_sampled_points = num_sampled_points
        # self.pool_extra_width = pool_extra_width
        self.pool_extra_width_factor = pool_extra_width_factor
    ...
    def forward(self, points, point_features, boxes3d):
        ...
        return RoIPointPool3dFunction.apply(
            points, point_features, boxes3d, self.pool_extra_width_factor, self.num_sampled_points
        )


class RoIPointPool3dFunction(Function):
    @staticmethod
    def forward(ctx, points, point_features, boxes3d, pool_extra_width_factor, num_sampled_points=512):
        """
        Args:
            ctx:
            points: (B, N, 3)
        ...
        pooled_boxes3d = box_utils.enlarge_box3d_by_factor(boxes3d.view(-1, 7), pool_extra_width_factor).view(batch_size, -1, 7)
